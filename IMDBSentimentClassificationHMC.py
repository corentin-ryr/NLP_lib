...
if __name__ == "__main__":
    ...
    traindataset = IMDBSentimentAnalysis(textFormat=textFormat, limit=10, datasetPath="imdbCleaned")
    testdataset = IMDBSentimentAnalysis(train=False, textFormat=textFormat, datasetPath="imdbCleaned")
