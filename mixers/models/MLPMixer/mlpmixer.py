...
class MLPMixer(nn.Module):
    ...
    def __init__(self, in_channels, dim, num_classes, patch_size:Union[int, Tuple[int]], image_size:Union[int, Tuple[int]], depth, token_dim, channel_dim):
        ...
        h_image, w_image = image_size if type(image_size) is tuple else (image_size, image_size)


        assert h_image % h_patch == 0 and w_image % w_patch == 0, 'Image dimensions must be divisible by the patch size.'
        self.num_patch =  (h_image // h_patch) * (w_image // w_patch)
